...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{pics/meta4.PNG}
    \caption{GUI folder added to the Desktop}
\end{figure}
A directory titled \texttt{msfgui} will now to added to your Dekstop.
To run the GUI the following steps have to be carried out.
\begin{figure}[H]
    \centering
